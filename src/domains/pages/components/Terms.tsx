...
export default function Terms(): ReactNode {
  return (
    <div className="bg-light-surface">
      <main className="flex flex-wrap max-w-3xl m-auto justify-center text-left gap-3 py-8 px-4 text-light-on-surface">
        ...
        <ol className="list-decimal pl-10 w-full">
          <li className="text-body-large w-full">
            Os materiais no site Mateus Pitura são fornecidos 'como estão'. O
            site Mateus Pitura não oferece garantias, expressas ou implícitas,
        ...
        <p className="text-body-large w-full">
          ...
          autorizado do site Mateus Pitura tenha sido notificado oralmente ou
        ...
        <p className="text-body-large w-full">
          Os materiais exibidos no site do site Mateus Pitura podem incluir
          erros técnicos, tipográficos ou fotográficos. O site Mateus Pitura não
          garante que qualquer material em seu site seja preciso, completo ou
          atual. O site Mateus Pitura pode fazer alterações nos materiais
          contidos em seu site a qualquer momento, sem aviso prévio. No entanto,
          o site Mateus Pitura não se compromete a atualizar os materiais.
        </p>
        <h2 className="text-title-large w-full">6. Links</h2>
        <p className="text-body-large w-full">
          O site Mateus Pitura não analisou todos os sites vinculados ao seu
          site e não é responsável pelo conteúdo de nenhum site vinculado. A
          inclusão de qualquer link não implica endosso pelo site Mateus Pitura
