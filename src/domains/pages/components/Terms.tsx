...
export default function Terms(): ReactNode {
  return (
    <div className="bg-light-surface flex flex-wrap max-w-3xl m-auto justify-center text-left gap-3 py-8 px-4 text-light-on-surface">
      <h1 className="text-headline-large w-full">Termos de Uso do Site</h1>
      <h2 className="text-title-large w-full">1. Termos</h2>
      <p className="text-body-large w-full">
        Ao acessar ao site Mateus Pitura, concorda em cumprir estes termos de
      ...
      <h2 className="text-title-large w-full">2. Uso de Licença</h2>
      <p className="text-body-large w-full">
        É concedida permissão para baixar temporariamente uma cópia dos
        materiais (informações ou software) no site Mateus Pitura, apenas para
      ...
      <p className="text-body-large w-full">
        ...
        dessas restrições e poderá ser rescindida pelo site Mateus Pitura a
      ...
      <ol className="list-decimal pl-10 w-full">
        <li className="text-body-large w-full">
          Os materiais no site Mateus Pitura são fornecidos 'como estão'. O site
          Mateus Pitura não oferece garantias, expressas ou implícitas, e, por
        ...
        <li className="text-body-large w-full">
          Além disso, o site Mateus Pitura não garante ou faz qualquer
      ...
      <h2 className="text-title-large w-full">4. Limitações</h2>
      <p className="text-body-large w-full">
        Em nenhum caso o site Mateus Pitura ou seus fornecedores serão
        ...
        decorrentes do uso ou da incapacidade de usar os materiais no site
        Mateus Pitura, mesmo que o site Mateus Pitura ou um representante
        autorizado do site Mateus Pitura tenha sido notificado oralmente ou por
      ...
      <h2 className="text-title-large w-full">5. Precisão dos materiais</h2>
      <p className="text-body-large w-full">
        Os materiais exibidos no site do site Mateus Pitura podem incluir erros
        técnicos, tipográficos ou fotográficos. O site Mateus Pitura não garante
        que qualquer material em seu site seja preciso, completo ou atual. O
        site Mateus Pitura pode fazer alterações nos materiais contidos em seu
        site a qualquer momento, sem aviso prévio. No entanto, o site Mateus
        Pitura não se compromete a atualizar os materiais.
      </p>
      <h2 className="text-title-large w-full">6. Links</h2>
      <p className="text-body-large w-full">
        O site Mateus Pitura não analisou todos os sites vinculados ao seu site
        e não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
        de qualquer link não implica endosso pelo site Mateus Pitura do site. O
        uso de qualquer site vinculado é por conta e risco do usuário.
      </p>
      <h2 className="text-title-large w-full">7. Modificações</h2>
      <p className="text-body-large w-full">
        O site Mateus Pitura pode revisar estes termos de serviço do site a
      ...
      <h2 className="text-title-large w-full">8. Lei aplicável</h2>
      <p className="text-body-large w-full">
        Estes termos e condições são regidos e interpretados de acordo com as
        leis do site Mateus Pitura e você se submete irrevogavelmente à
