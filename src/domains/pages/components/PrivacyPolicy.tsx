    ...
    <div className="bg-light-surface">
      <main className="flex flex-wrap max-w-3xl m-auto justify-center text-left gap-3 py-8 px-4 text-light-on-surface">
        ...
        <p className="text-body-large w-full">
          A sua privacidade é extremamente importante para nós. Comprometemo-nos
          a respeitar sua privacidade e proteger qualquer informação pessoal que
          você possa fornecer através do nosso site, Mateus Pitura, localizado
          em https://mateuspitura.github.io/web-react-portfolio/.
        </p>
        ...
        <h2 className="text-title-large w-full">Compartilhamento de Informações</h2>
        <p className="text-body-large w-full">
        ...
        <ul className="list-disc pl-10">
          ...
          <li className="text-body-large w-full">
            Não causar danos aos sistemas físicos e lógicos de Mateus Pitura,
            seus fornecedores ou terceiros.
          </li>
        </ul>
